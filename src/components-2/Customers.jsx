...
// To remove Indigg and Polysynth and place Polygon and Quickswap instead.
// To place Polygon, Alchemy and Moonpay in the middle row.

function Customers(){
  return (
    <section class="container rounded-5 bg-faded-primary mt-5 pt-5">
        <div class="  py-5 px-4 p-sm-5">
            <div class="d-lg-flex align-items-center g-0 py-2 py-sm-3 py-md-4 p-xl-5">
                <div class="order-lg-2 text-center text-lg-start ps-lg-5 mx-auto me-lg-0">
                    <h2 class="h2 mb-4">Join other community members from top projects 🙌</h2>
                    <p class="pb-3 mb-3 mb-lg-4">We already have the best growth minds from top projects in our community.</p>
                    <Link href = "/community#signup-form" passHref scroll={false}>
                        <a class="btn btn-dark d-none d-lg-inline-flex" >Join our community</a>
                    </Link>
                </div>
                <div class="order-lg-1 w-100 mx-auto mx-lg-0" style={{maxWidth: "558px"}}>
                    <div class="row row-cols-3 g-3 g-sm-4 g-lg-3 g-xl-4">
                        ...
                        <div class="col">
                            <div class="bg-light rounded-3 d-flex flex-column justify-content-center align-items-center w-100 aos-init aos-animate" data-aos="zoom-in" data-aos-easing="ease-out-back" data-aos-delay="300" style = {{minHeight: '100px'}}>
                                <div class='d-flex flex-column justify-content-center align-items-center w-100'>
                                <img src="/assets/img/investors/polygon.png" alt="Eternal Dragons" className='py-3 px-3 py-lg-4 px-lg-4' style = {{maxHeight: '120px'}}/>
                        ...
                        <div class="col">
                            <div class="bg-light rounded-3 d-flex flex-column justify-content-center align-items-center w-100 aos-init" data-aos="zoom-in" data-aos-easing="ease-out-back" data-aos-delay="600" style = {{minHeight: '100px'}}>
                                <div class='d-flex flex-column justify-content-center align-items-center w-100'>
                                <img src="/assets/img/customers/zerion.png" alt="Indi.gg" className='p-4' style = {{maxHeight: '100px'}}/>
                    ...
                    <div class="d-lg-none text-center pt-4 mt-2 mt-md-3 aos-init aos-animate" data-aos="zoom-in" data-aos-easing="ease-out-back" data-aos-delay="900">
                        <Link href = "/community#signup-form" passHref scroll={false}>
                            <a class="btn btn-dark">Join our community</a>
                        </Link>
                    </div>
                </div>
            </div>
