...
function Customers(){
  return (
    <section class="container rounded-5 bg-dark mt-5 pt-5">
        <div class="  py-5 px-4 p-sm-5">
            <div class="d-lg-flex align-items-center g-0 py-2 py-sm-3 py-md-4 p-xl-5">
                <div class="order-lg-2 text-center text-lg-start ps-lg-5 mx-auto me-lg-0">
                    <h2 class="h1 mb-4">Join our list of  marquee partners 🙌</h2>
                    <p class="pb-3 mb-3 mb-lg-4 lead">We are live across 50+ global projects helping them acquire & engage the right users for their platform.</p>
                </div>
                    ...
                    <div class="row row-cols-3 g-3 g-sm-4 g-lg-3 g-xl-4">
                        ...
                        <div class="col">
                            <div class="bg-light rounded-3 d-flex flex-column justify-content-center align-items-center w-100 aos-init" data-aos="zoom-in" data-aos-easing="ease-out-back" data-aos-delay="800" style = {{minHeight: '100px'}}>
                                ...
                                <img src="/assets/img/customers/axie.png" alt="Eternal Dragons" className='p-3' style = {{maxHeight: '85px'}}/>
